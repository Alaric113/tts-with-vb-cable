...
from utils_deps import CABLE_INPUT_HINT, ENGINE_EDGE, ENGINE_PYTTX3
...
def build_main_window_ui(app):
    ...
    app.local_device_combo = ctk.CTkOptionMenu(out, values=["Default"], corner_radius=CORNER_RADIUS, fg_color=FG_COLOR, button_color=app.BTN_COLOR, button_hover_color=app.BTN_HOVER_COLOR)
    app.local_device_combo.set("Default")
    app.local_device_combo.configure(state="disabled")
